...
button{padding:10px 16px;cursor:pointer}.dropzone{border:2px dashed #b8b8b8;border-radius:12px;padding:24px;background:#fafafa;margin:16px 0;max-width:680px}.dropzone.dragover{border-color:#1a73e8;background:#eef5ff}.small{font-size:13px;color:#666;margin-top:4px}#progressBox{display:none;margin-top:22px;max-width:680px}.progress-wrap{height:18px;background:#eee;border-radius:999px;overflow:hidden}.progress-bar{height:18px;width:0%;background:#1a73e8;transition:width .25s}.progress-line{margin-top:10px;font-weight:700}.progress-detail{color:#666;margin-top:5px;font-size:14px}.recordbox{padding:10px 12px;background:#eef8f0;border:1px solid #b8dfc0;border-radius:6px;max-width:680px;margin:14px 0;color:#245b2f}
</style></head><body><h1>Meetrapport generator</h1>
<p class="hint">Upload de meetstaat, 2D-plattegronden, 3D-plattegronden en eventueel het .fml-bestand. Adresgegevens, opdrachtgever en adviseur worden automatisch uit het Softr-record gehaald. De meetstaat komt alleen in het rapport; het .fml-bestand komt wel in de zip maar niet in het rapport.</p>
{% if record_id %}<div class="recordbox">Record gekoppeld: <b>{{record_id}}</b></div>{% endif %}
